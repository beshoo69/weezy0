...
<head>
    ...
    <title>لوحة التحكم الاحترافية - فايز تڨي</title>
            ...
            <div class="content-section">
                ...
                <div class="quick-actions-grid">
                    ...
                    <a href="add-subtitles.php" class="quick-action-card">
                        ...
                        <div class="quick-action-desc">إضافة ترجمات للمحتوى</div>
                        <span class="badge badge-danger">جديد</span>
                    </a>
                    ...
                    <a href="import-tmdb.php" class="quick-action-card">
                        <div class="quick-action-icon">
                            <i class="fas fa-cloud-download-alt"></i>
                        </div>
                        <div class="quick-action-title">استيراد أفلام</div>
                        <div class="quick-action-desc">جلب أحدث الأفلام من TMDB</div>
                    </a>
                    
                    <a href="import-tv.php" class="quick-action-card">
                        <div class="quick-action-icon">
                            <i class="fas fa-cloud-download-alt"></i>
                        </div>
                        <div class="quick-action-title">استيراد مسلسلات</div>
                        <div class="quick-action-desc">جلب أحدث المسلسلات</div>
                    </a>
                    
                    <a href="import-top-series.php" class="quick-action-card">
                        <div class="quick-action-icon">
                            <i class="fas fa-star"></i>
                        </div>
                        <div class="quick-action-title">أفضل المسلسلات</div>
                        <div class="quick-action-desc">استيراد أعلى التقييمات</div>
                    </a>
